...
def main():
    os.makedirs(cfg.FLORENCE_OUT, exist_ok=True)
    ...
    processor = AutoProcessor.from_pretrained(cfg.FLORENCE_MODEL)
    model = AutoModelForCausalLM.from_pretrained(cfg.FLORENCE_MODEL)
    ...
    trainer.train()
    trainer.save_model(cfg.FLORENCE_OUT)
    processor.save_pretrained(cfg.FLORENCE_OUT)
